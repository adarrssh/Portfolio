  ...
  return (
    <Flex className='glass' w={'100%'}   justify='center'  position={'fixed'} top={'0px'} id='nav-menu' zIndex={10}>
        <Flex   justify='space-between' align='center' w={['90%','90%','80%','80%']}>
                <Flex>
                <Text _hover={{ cursor: 'pointer' }} padding={['1rem 1rem', '1rem', '1rem 0rem', '1rem 0rem', '1rem 0rem', '1rem 0rem']} fontSize={['md', 'lg', 'xl', 'xl']} color={'#EDBB3C'}>Adarsh</Text>
                </Flex>
                ...
                <Drawer placement={'top'} onClose={onClose} isOpen={isOpen} >
                    ...
                    <DrawerHeader borderBottomWidth='1px'>
                        <Flex justifyContent={'space-between'}>
                            <Text _hover={{ cursor: 'pointer' }}>Adarsh's Portfolio</Text>
                            <IconButton 
                            aria-label="Close"
                            variant={'ghost'}
                            icon={<CloseIcon/>}
