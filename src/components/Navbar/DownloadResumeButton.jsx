...
const DownloadResumeButton = () => {
  ...
  const handleDownload = () => {
    ...
    viewLink.href = 'https://drive.google.com/file/d/1Av6W9_T1dNHu-SGwKVn1kPV7PK3b5Pul/view?usp=sharing'; // View link
    viewLink.target = '_blank';
    viewLink.click();

    const downloadLink = document.createElement('a');
    downloadLink.href = 'https://drive.google.com/uc?export=download&id=1Av6W9_T1dNHu-SGwKVn1kPV7PK3b5Pul'; // Direct download link
    downloadLink.download = 'Adarsh_resume.pdf';
    downloadLink.click();
  };
