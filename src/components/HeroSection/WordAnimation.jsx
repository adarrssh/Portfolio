...
const WordAnimation = () => {
  const words = [
    { text: 'JavaScript', color: '#FDE68A' },
    { text: 'React', color: 'darkturquoise' },
    { text: 'Node.js', color: '#DB7093' },
    { text: 'MongoDB', color: '#FDE68A' },
    { text: 'Express', color: '#FDE68A' },
    { text: 'Tailwind', color: '#FDE68A' },
    {text:'AWS', color: '#FDE68A'},
