...
const ContactMe = () => {
    ...
    const allSkills =[
        ...
        , {
            id:2,
            title:'adarsh0050@gmail.com',
            href:'mailto:adarsh0050@gmail.com',
            src:email,
            width:'20px',
            colorScheme: 'gray',
        ...
        , {
            id:3,
            title:'LinkedIn',
            href:'https://www.linkedin.com/in/adarsh002/',
            src:linkedin,
            width:'20px',
            colorScheme: 'gray',
        ...
        , {
            id:4,
            title:'GitHub',
            href:'https://github.com/adarrssh',
            src:githubIcon,
            width:'20px',
            colorScheme: 'gray',
  ...
  const handleSubmit = (e) => {
    ...
    setIsLoading(true);
      ...
      emailjs.send('service_88j1nba', 'template_623996v', formData,'pH7SHPPYysM4jW33B')
        .then((response) => {
  ...
  return (
    ...
    <Flex w={'100%'} gap={'10px'} justifyContent={'center'} alignItems={'center'}  flexWrap={'wrap'}  >
        ...
        <Text fontSize={'xl'}>Bengaluru, India</Text>
    </Flex>
    </Flex>
